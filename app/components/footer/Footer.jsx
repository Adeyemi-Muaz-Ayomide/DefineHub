...
//     // <footer className=" z-40 mt-10  animate__animated animate__fadeIn animate__faster bottom-0 left-0 w-full border-t border-gray-700 border-opacity-50 transition-all">
